...
[RequireComponent(typeof(CharacterSystemController))]
public class CharacterInput : MonoBehaviour
{
    ...
    private CharacterSystemController _characterSystem;
    ...
    private void OnEnable()
    {
        ...
        _characterSystem = GetComponent<CharacterSystemController>();
    }
    ...
    private void LateUpdate()
    {
        ...
        _targetPosition = CountTargetPosition(_targetPosition, _targetOffset, _lerpTargetPositionParam, _rayHit, _groundLayer);
        _characterSystem.SetInput(_axisInput, _targetPosition);
    ...
    private Vector3 CountTargetPosition(Vector3 TargetPosition, Vector3 TargetOffset, float LerpParam, RaycastHit Hit, LayerMask GroundLayer)
    {
